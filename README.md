...
Домашнее задание 1 - научиться основам работы с ООП

В процессе выполнения домашних заданий мы научились выполнять множеству многих команд для упрощения и оптимизации кода

## Установка:

1. Клонируйте репозиторий:
```
git clone https://github.com/DianaHaseo/Homework2.git
```
